...
# Create the fixed JavaScript file
cat > static/js/fixed-send-message.js << 'JSEOF'
...
# This uses awk to find the line with the bootstrap script and add our script before it
awk '
/script src="https:\/\/cdn.jsdelivr.net\/npm\/bootstrap@5.3.5\/dist\/js\/bootstrap.bundle.min.js"/ {
    print "    <script src=\"{{ url_for('"'"'static'"'"', filename='"'"'js/fixed-send-message.js'"'"') }}\"></script>"
}
{ print }
' templates/index.html.bak > templates/index.html.new

# Replace the original file with the modified one
mv templates/index.html.new templates/index.html

echo "Fix applied successfully!"
echo "A backup of the original file is saved as templates/index.html.bak"
echo "To test the fix, restart your Flask application and try sending a message."
